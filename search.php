	       							...
	       							<div class='col-sm-4'>
	       								<div class='box box-solid'>
		       								<div class='box-body prod-body'>
		       									<img src='".$image."' width='100%' height='230px' class='thumbnail' style='width: 100%; height: 230px; object-fit: cover;'>
		       									<h5><a href='https://adaajaipur.free.nf/ecommerce/product.php?product=".$row['slug']."'>".$highlighted."</a></h5>
		       								</div>
